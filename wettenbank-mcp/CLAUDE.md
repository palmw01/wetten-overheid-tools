...
| `wettenbank_artikel` | Fetch one article by BWB-id + article number — returns JSON with `citeertitel`, `versiedatum`, `structuurpad`, `leden`, `tekst`, `bronreferentie`, `waarschuwing` |
